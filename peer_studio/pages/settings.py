...
st.title("⚙️ Settings")
st.markdown("Inspect local environment metrics, verify sqlite storage parameters, and re-initialize inference catalogs.")
...
st.markdown("### 🗄️ Database Storage Metrics")
